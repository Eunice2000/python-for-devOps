...
studentName = "adediran eunice adebukola"
substring = "eunice"

if substring in studentName:
    print( "that name", substring , "is part of the student name ")
else:
    print( " that name", substring, "is not part of the student")
